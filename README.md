...
1. Instalar Cloudflare via winget con el siguiente comando en powershell: _winget install --id Cloudflare.cloudflared_.
2. Iniciar sesión con una cuenta gratuita creada en Cloudflare con el siguiente comando: _cloudflared tunnel login_.
3. Solicitar una url pública con el siguiente comando: _cloudflared tunnel --url http://localhost:5678_.
...
5. Abrir powershell y navegar a la ruta D:\docker\n8n. Luego ejecutar el comando: _docker compose up -d_.
...
## Instalación de workflow checkpoint1_javier_dianderas.json
